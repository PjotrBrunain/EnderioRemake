...
public class AlloySmelterMenu extends AbstractContainerMenu
{
    ...
    public AlloySmelterMenu(int id, Inventory inv, BlockEntity entity, ContainerData data)
    {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.ALLOY_SMELTER_BLOCK.get());
    }
